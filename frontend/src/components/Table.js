...
export default function Table(props) {
    ...
    const onClickHandler =(e)=>{
        editUser(user.id,user.eEmail,user.eRoomType,user.eRoomNumber,user.eStartTime,user.eEndTime); 
        ...
        let hoursDiff = timeDiff / (3600); // difference in hours
        let price;
        if (user.eRoomType==="A") {
            price=hoursDiff*100;
    ...
    const updateUser = (currentUser)=>{
        ref.current.click();
        setUser({id:currentUser._id, eEmail: currentUser.email,eRoomType:currentUser.roomType,eRoomNumber: currentUser.roomNumber,eStartTime:currentUser.startTime, eEndTime:currentUser.endTime}); // Will set the edit fields to the current value before editing
    }
        ...
        <div className="modal-dialog">
            ...
            <div className="modal-body">
                ...
                <div className="mb-3">
                    ...
                    <select className="form-select" name="eRoomType" id="eRoomType" value={user.eRoomType} onChange={onChange}>
                ...
                <div className="mb-3">
                    ...
                    <select className="form-select" name="eRoomNumber" id="eRoomNumber" value={user.eRoomNumber} onChange={onChange}>
                    <option value="">Select Room Number</option>
                            {data[user.eRoomType].map((roomNumber)=>
    ...
    {/* Edit User End */}
        ...
        <table className="table table-hover text-center" >
            ...
            <div className="text-center">
                {users.length===0 && <h2 className="justify-content-center mx-2" style={{color:"black"}}><strong>No bookings yet...</strong></h2>}
            </div>
        </>
    )
}